    ...
    <div id="page-wrapper" class="gray-bg">
        ...
        <div class="wrapper wrapper-content">
            <div class="middle-box text-center animated fadeInRightBig">
                <form action="check_operation?operation=update" method="post" >
                    <ul class="move_ul" >
                        <p>
                        <li class="move_li">
                            <span class="span1">员工ID：</span>
                            <input  class="input1"  type="text" name="empId" value="${checking.empId}" disabled/>
                        </li>
                        </p>
                        <p>
                        <li class="move_li">
                            <span class="span1">员工名称：</span>
                            <input  class="input1" type="text" name="empName" value="${checking.empName} " disabled/>
                        </li >
                        </p>
                        <p>
                        <li class="move_li">
                            <span class="span1">部门名称：</span>
                            <input  class="input1" type="text" name="depName" value="${checking.depName}" />
                        </li>
                        </p>
                        <p>
                        <li class="move_li">
                            <span class="span1">上班时间：</span>
                            <input  class="input1" type="text" name="startDate" value="${checking.startDate}" />
                        </li>
                        </p>
                        <p>
                        <li class="move_li">
                            <span class="span1">请假/正常：</span>
                            <input  class="input1" type="text" name="state" value="${checking.state}" placeholder=" (0/1)" />
                        </li>
                        </p>
                        ...
                        <li class="move_li_last">
                            <textarea class="ckeditor" name="note" value="${checking.note}" ></textarea>
                        </li>
                        </p>
                    ...
                    <input style="display: inline;width: 130px;height: 60px;font-size:19px;position: relative;top:-434px;left:150px;background-color: #1ab394;color: white;border-color: #1ab394;" type="submit" value="修改"/>
                </form>
            </div>
        </div>
        <div class="footer">
