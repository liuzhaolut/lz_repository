        ...
        <div class="ibox-title">
            ...
            <div class="ibox-tools">
                ...
                <ul class="dropdown-menu dropdown-user">
                    <li><a href="selectEmp?type=deleteAll" class="dropdown-item">清空员工</a>
                    </li>
            ...
            <div class="row">
                ...
                <div class="col-sm-3">
                    <div class="input-group mb-3">
                        <input type="text" class="form-control form-control-sm" id="sousuo" placeholder="请输入员工号">
                        <div class="input-group-append">
                            <button class="btn btn-sm btn-primary" onclick="selectOne()" type="button">搜索!</button>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <table class="table table-striped">
                    <thead>
                        <tr>
                            ...
                            <th>地址</th>
                            <th>操作</th>
<%--                            <th><a href="" style="text-decoration: none; color: #000;">新增员工</a></th>--%>
                        </tr>
                    </thead>
                    <tbody>
                    <%
                        HttpSession httpSession = request.getSession();
                        Emp empOne = (Emp) httpSession.getAttribute("empOne");
                        List<Emp> empList = (List<Emp>) httpSession.getAttribute("empList");
                        if (empOne != null) {
                    %>
                    <tr>
                        <td><%=empOne.getEmpId()%>
                        </td>
                        <td><%=empOne.getEmpName()%>
                        </td>
                        <td><%=empOne.getEmpsex()%>
                        </td>
                        <td><%=empOne.getEmpage()%></td>
                        <td><%=empOne.getWork_year()%>
                        </td>
                        <td><%=empOne.getTelephone()%>
                        </td>
                        <td><%=empOne.getAddress()%>
                        </td>
                        <td><a href="selectEmp?type=selectUpdate&empId=<%=empOne.getEmpId()%>"
                               style="padding: 0 10px;border: 1px solid #C9C9C9;margin-right: 15px;margin-left: -40px;color: black">修改</a>
                            <a href="selectEmp?type=deleteOne&empId=<%=empOne.getEmpId()%>"
                               style="padding: 0 10px;border: 1px solid #C9C9C9;margin-right: 15px;color: black">删除</a>
                        </td>
                    </tr>
                    <%
                    ...
                    <tr>
                        ...
                        <td><a href="selectEmp?type=selectUpdate&empId=<%=e.getEmpId()%>"
                               style="padding: 0 10px;border: 1px solid #C9C9C9;margin-right: 15px;margin-left: -40px;color: black">修改</a>
                            <a href="selectEmp?type=deleteOne&empId=<%=e.getEmpId()%>"
                               style="padding: 0 10px;border: 1px solid #C9C9C9;margin-right: 15px;color: black">删除</a>
                        </td>
                    </tr>
                    <%
        ...
        <script>
             ...
             */
            function selectOne() {
                var empId = $("#sousuo").val();
                // $.get("selectEmpOne?empId=" + empId);
                document.location.href = "selectEmp?empId=" + empId+"&type=selectOne";
            }
        </script>
