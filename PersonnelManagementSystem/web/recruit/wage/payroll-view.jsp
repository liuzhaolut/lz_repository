...
<script type="text/javascript">
    ...
    <%--    var eId = $("#eId").val();--%>
    <%--    $.ajax({--%>
    <%--        url: "/PersonnelManagementSystem/wage/WageServlet?opt=selectId&eId="+eId,--%>
    <%--        dataType:"JSON",--%>
    ...
    <%--                "                        <td>"+data.allSal+"</td>\n" +--%>
    <%--                "\n" +--%>
    <%--                "                <td><a href=\"/PersonnelManagementSystem/wage/WageServlet?opt=delete&id=+data.salId+">删除</a><td>\n" +--%>
    <%--            "                        <td><a href=\"/PersonnelManagementSystem/wage/WageServlet?opt=update&salid=${u.salId}\"></i>修改</a></td>\n" +--%>
    <%--            "                        <td><a href=\"/PersonnelManagementSystem/wage/WageServlet?opt=insert\"></i>插入</a></td>     </tr>";--%>
    <%--            //定位  将tdStr显示在原来地方--%>
    <%--            $("tbody").html(tdStr);--%>
    <%--        },error: function () {--%>
    <%--            alert("err!!!");--%>
                ...
                dataType:"JSON",
                 success:function (data) {
                     var tdStr = "<tr>\n" +
                         ...
                         "                        <td>"+data.allSal+"</td>\n" +
                         "\n" +
                         "                        <td><a href=\"/PersonnelManagementSystem/wage/WageServlet?opt=delete&id="+data.salId+"\"></i>删除</a></td>\n" +
                         "                        <td><a href=\"/PersonnelManagementSystem/wage/WageServlet?opt=update&salid="+data.salId+"\"></i>修改</a></td>\n" +
                         "                        <td><a href=\"/PersonnelManagementSystem/wage/WageServlet?opt=insert\"></i>插入</a></td>\n" +
                         "                    </tr>";
                     //定位  将tdStr显示在原来地方
                    $("tbody").html(tdStr);
                },error: function () {
				...
				<div class="row border-bottom">
					<nav class="navbar navbar-static-top white-bg" role="navigation" style="margin-bottom: 0">
						...
						<ul class="nav navbar-top-links navbar-right">
							<li>
								<span class="m-r-sm text-muted welcome-message">欢迎来到人力资源管理系统后台</span>
							</li>
        ...
        <div class="ibox-content">
            <div class="row">
                ...
                <div class="col-sm-3">
                    <div class="input-group mb-3">
                        <input type="text" id="eId" class="form-control form-control-sm" placeholder="请输入员工ID">
            ...
            <div class="table-responsive">
                <table class="table table-striped">
                    ...
                    <c:forEach items="${salaryList}" var="u" >
                    <tr>
                        <td>${u.salId}</td>
                        <td>${u.empId}</td>
                        <td>${u.empName}</td>
                        ...
                        <td><a href="/PersonnelManagementSystem/wage/WageServlet?opt=delete&id=${u.salId}"></i>删除</a></td>
                        <td><a href="/PersonnelManagementSystem/wage/WageServlet?opt=update&salid=${u.salId}"></i>修改</a></td>
                        <td><a href="/PersonnelManagementSystem/wage/WageServlet?opt=insert"></i>插入</a></td>
                    </tr>
                    </c:forEach>
